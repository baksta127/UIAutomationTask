...
public class LoginTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("baksta127");
    ...
    public void testNegativeLogin(){
        driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("gaavin");
        driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("admin231");
        driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/main/div/div[2]/div/div/div/div[2]/div/div/form/button")).click();
